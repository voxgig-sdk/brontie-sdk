...
const testSeed = `map[string]any{"entity": map[string]any{"balance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "voucher": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
