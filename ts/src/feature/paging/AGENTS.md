...
| Runtime template | `.sdk/tm/ts/src/feature/paging/` (copied here on `generate`; `FEATURE_Name`/`FEATURE_VERSION` substituted) |
...
- **Behaviour**: edit the runtime template under
  `.sdk/tm/ts/src/feature/paging/`, then regenerate.
