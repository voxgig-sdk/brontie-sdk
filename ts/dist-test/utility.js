...
function envOverride(m) {
    if ('TRUE' === process.env.BRONTIE_TEST_LIVE ||
        'TRUE' === process.env.BRONTIE_TEST_OVERRIDE) {
    ...
    m.BRONTIE_TEST_EXPLAIN = process.env.BRONTIE_TEST_EXPLAIN || m.BRONTIE_TEST_EXPLAIN;
    return m;
}
