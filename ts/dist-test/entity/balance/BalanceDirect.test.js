...
(0, node_test_1.describe)('BalanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-balance', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-balance', setup.live))
            return;
...
function liveScenariosActive() { return true && process.env.BRONTIE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BrontieSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.BRONTIE_APIKEY,
        }));
        let idmap = env['BRONTIE_TEST_BALANCE_ENTID'];
    ...
    const client = new __1.BrontieSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BalanceDirect.test.js.map