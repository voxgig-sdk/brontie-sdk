# Brontie TypeScript SDK Reference

Complete API reference for the Brontie TypeScript SDK.
...
#### `BrontieSDK.test(testopts?, sdkopts?)`
...
Create a new `Voucher` entity instance.
...
**Returns:** `VoucherEntity` instance.
...
| --- | --- | --- | --- |
| `alertAt` | `number | null` | Yes | The threshold resolved to a euro figure: `lastTopUp × alertPercent`. |
| `alertPercent` | `number` | Yes | Percentage of the most recent top-up at which the low-balance threshold sits. |
| `balance` | `number` | Yes |  |
| `currency` | `string` | Yes |  |
...
Return the parent `BrontieSDK` instance.
