...
describe("BalanceDirect", function()
  it("should direct-load-balance", function()
    local setup = balance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-balance", setup.live and "live" or "unit")
