...
local VoucherEntity = {}
VoucherEntity.__index = VoucherEntity


function VoucherEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VoucherEntity)
  self._name = "voucher"
  self._client = client
...
function VoucherEntity:get_name()
  return self._name
end


function VoucherEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VoucherEntity.new(self._client, opts)
end
...
function VoucherEntity:mark_deleted()
  self._deleted = true
end


function VoucherEntity:deleted()
  return true == self._deleted
end


function VoucherEntity:data_set(args)
  if args ~= nil then
...
function VoucherEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VoucherEntity:match_set(args)
  if args ~= nil then
...
function VoucherEntity:match_get()
...
function VoucherEntity:stream(action, args, callopts)
...
---@param reqdata VoucherCreateData
---@param ctrl? table
---@return Voucher
---@return string? err
function VoucherEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function VoucherEntity:_run_op(ctx, post_done)
  local utility = self._utility
