...
class BrontieTimeoutFeature extends BrontieBaseFeature
{
    ...
    private function _with_timeout(BrontieContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BrontieContext $_ctx, float $ms): void
    {
        $client = $this->client;
