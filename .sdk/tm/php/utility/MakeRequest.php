...
// Brontie SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BrontieMakeRequest
{
    public static function call(BrontieContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BrontieResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BrontieResponse($fetched);
        } else {
