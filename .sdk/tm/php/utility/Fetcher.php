...
class BrontieFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BrontieSDK/1.0)';
    ...
    public static function call(BrontieContext $ctx, string $fullurl, array $fetchdef): array
    {
