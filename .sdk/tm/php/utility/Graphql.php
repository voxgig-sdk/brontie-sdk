...
class BrontieGraphql
{
    ...
    // equivalent.
    public static function body(BrontieContext $ctx): mixed
    {
    ...
    public static function errors(BrontieContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
