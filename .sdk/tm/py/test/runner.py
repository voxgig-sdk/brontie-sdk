...
class BrontieTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BrontieTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = BrontieTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = BrontieTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
