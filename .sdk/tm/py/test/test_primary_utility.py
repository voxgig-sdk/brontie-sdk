...
from projectname_sdk import BrontieSDK
from projectname_sdk.core.spec import BrontieSpec
from projectname_sdk.core.result import BrontieResult
from projectname_sdk.core.operation import BrontieOperation
from projectname_sdk.core.error import BrontieError
from projectname_sdk.feature.base_feature import BrontieBaseFeature
...
_runner = makeRunner(TEST_JSON_FILE, BrontieSDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = BrontieSpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = BrontieSDK.test(None, None)
        utility = client._utility
    ...
    def test_feature_init_basic(self):
        init_client = BrontieSDK.test(None, None)
        ...
        class TestInitFeature(BrontieBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BrontieBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BrontieSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BrontieSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BrontieSDK.test(None, setup.get('a') or {})
