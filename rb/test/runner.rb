...
module BrontieTestRunner
  ...
  def self.env_override(m)
    live = getenv("BRONTIE_TEST_LIVE")
    override = getenv("BRONTIE_TEST_OVERRIDE")
    ...
    explain = getenv("BRONTIE_TEST_EXPLAIN")
    m["BRONTIE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BrontieTestRunner
Helpers = BrontieHelpers
Vs = VoxgigStruct
