# Brontie Ruby SDK Reference

Complete API reference for the Brontie Ruby SDK.
...
#### `BrontieSDK.test(testopts = nil, sdkopts = nil)`
...
| --- | --- | --- | --- |
| `alertAt` | `Object` | Yes | The threshold resolved to a euro figure: `lastTopUp × alertPercent`. |
