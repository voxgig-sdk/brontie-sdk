...
Brontie Partner API client, generated from the OpenAPI spec.

Issue coffee vouchers against a pre-funded balance.

Learn more about Brontie Partner API at [brontie.ie](https://brontie.ie).

This is an unofficial SDK for the Brontie Partner public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.

Learn more about Voxgig SDKs at [voxgig.com/sdk](https://voxgig.com/sdk/).

Full documentation for this SDK: [https://voxgig-sdk.github.io/brontie-sdk/](https://voxgig-sdk.github.io/brontie-sdk/)
...
This SDK exposes the API as a small set of **semantic entities** — Balance and Voucher — that you
...
```bash
cd go-mcp && go build -o brontie-mcp .
```
...
```json
{
  "mcpServers": {
    "brontie": {
      "command": "/abs/path/to/brontie-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Balance** | The Balance entity (load). | `/api/v1/balance` |
| **Voucher** | The Voucher entity (create). | `/api/v1/vouchers` |
...
```go
import sdk "github.com/voxgig-sdk/brontie-sdk/go"
...
- Upstream API: [https://www.brontie.ie](https://www.brontie.ie)
...
Generated from the Brontie Partner API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
