# Brontie PHP SDK Reference

Complete API reference for the Brontie PHP SDK.
...
#### `BrontieSDK::test($testopts = null, $sdkopts = null)`
...
Create a new `VoucherEntity` instance. Pass `null` for no initial data.

#### `options_map(): array`

Return a deep copy of the current SDK options.

#### `get_utility(): BrontieUtility`
...
| --- | --- | --- | --- |
| `alertAt` | `mixed` | Yes | The threshold resolved to a euro figure: `lastTopUp × alertPercent`. |
