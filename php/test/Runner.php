...
class BrontieTestRunner
{
    ...
    {
        $live = self::getenv('BRONTIE_TEST_LIVE');
        $override = self::getenv('BRONTIE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BRONTIE_TEST_EXPLAIN');
...
class_alias('BrontieTestRunner', 'Runner');
class_alias('BrontieHelpers', 'Helpers');
