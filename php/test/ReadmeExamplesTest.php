...
// Brontie SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BrontieSDK::test)
...
{
    private const SDK_CLASS = 'BrontieSDK';
    ...
    private const SDK_BASE = 'brontie_sdk';
