...
// Brontie SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BrontieOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BrontieOmni::structfix($now, Struct::undef()))
                        !== json_encode(BrontieOmni::structfix($val, Struct::undef()))) {
