...
class BrontiePagingFeature extends BrontieBaseFeature
{
    ...
    private function _graphql_pre_request(BrontieContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(BrontieContext $ctx): bool
    {
