...
class BrontieRatelimitFeature extends BrontieBaseFeature
{
    ...
    private function _acquire(BrontieContext $ctx): void
    {
    ...
    private function _track(BrontieContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
