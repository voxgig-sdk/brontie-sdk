...
// Brontie SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BrontieTestFeature extends BrontieBaseFeature
{
    ...
    public function init(BrontieContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BrontieContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BrontieContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BrontieContext $ctx, $op, $args): array
    {
