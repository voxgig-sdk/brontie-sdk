...
class VoucherEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VoucherEntity($this->_client, $opts);
    }

    /**
     * @param Voucher|array $args Voucher data (assoc-array) to store.
     */
    ...
    /**
     * @return Voucher|array The current Voucher data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Voucher fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Voucher fields).
     */
     ...
     *
     * @param VoucherCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VoucherCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Voucher|array The created Voucher as an assoc-array at the
