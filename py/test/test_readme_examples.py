# Brontie SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BrontieSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BrontieSDK(...) and BrontieSDK.test(...) become
#      BrontieSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "brontie_sdk"
_SDK_CLASS = "BrontieSDK"
