...
from brontie_sdk.core.control import BrontieControl
...
from brontie_sdk.core.helpers import get_ctx_prop, to_map
...
class BrontieContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, BrontieResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BrontieError(code, msg, self)
