...
from brontie_sdk.utility import register

# Load features
from brontie_sdk.feature.base_feature import BrontieBaseFeature
from brontie_sdk.features import _has_feature, _make_feature
...
class BrontieSDK:
    ...
    def get_utility(self):
        return BrontieUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BrontieSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Balance(self, data=None) -> "BalanceEntity":
        ...
        from brontie_sdk.entity.balance_entity import BalanceEntity
        return BalanceEntity(self, data)


    def Voucher(self, data=None) -> "VoucherEntity":
        """Entity factory: client.Voucher().list() / client.Voucher().load({"id": ...})."""
        from brontie_sdk.entity.voucher_entity import VoucherEntity
        return VoucherEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BrontieSDK":
        if sdkopts is None:
            sdkopts = {}
