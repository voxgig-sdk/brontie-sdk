// Command Brontie-cli is a CLI + REPL for the Brontie SDK,
...
const prompt = "brontie"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "balance voucher"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BRONTIE_APIKEY (api key), BRONTIE_BASE (base url override)")
