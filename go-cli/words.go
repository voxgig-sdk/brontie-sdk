...
func registerSDKWords(r *eng.Registry, client *sdk.BrontieSDK) {
...
func runOp(client *sdk.BrontieSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
